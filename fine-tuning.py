...
model = GatedCRNN(num_classes=opt.num_class, input_channel=opt.input_channel)
print(model)
...
for epoch in range(epochs):
    ...
    if current_accuracy > best_accuracy:
        ...
        torch.save(model.state_dict(), 'pretrained_model/best_accuracy_final.pth')
        print('best_accuracy: ', best_accuracy)
    if current_norm_ED > best_norm_ED:
        best_norm_ED = current_norm_ED
        torch.save(model.state_dict(), 'pretrained_model/best_norm_ED_final.pth')
